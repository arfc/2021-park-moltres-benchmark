...
\begin{table}[htb!]
	...
	\begin{tabular}{l l c S S}
		...
		\midrule
		\multirow{2}{*}{1.1} &
		\multirow{2}{*}{$\sum_j \lambda_j C_j$ [m$^{-3}\cdot$s$^{-1}$]} & AA' & 0.606 & 0.346 \\
		& & BB' & 0.378 & 0.294 \\
		\midrule
		\multirow{4}{*}{1.2} &
		...
		\cmidrule{2-5}
		& \multirow{2}{*}{$u_y$ [m$\cdot$s$^{-1}$]} & AA' & 0.236 & 0.329 \\
		& & BB' & 0.238 & 0.356 \\
		\cmidrule{2-5}
		& \multirow{2}{*}{$T$ [K]} & AA' & 0.064 & 0.057 \\
		& & BB' & 0.070 & 0.080 \\
		\cmidrule{2-5}
		& \multirow{2}{*}{$\sum_j \lambda_j C_j$ [m$^{-3}\cdot$s$^{-1}$]} & AA' & 1.079 & 0.460 \\
		& & BB' & 0.5780 & 1.194 \\
		\bottomrule
	\end{tabular}
	\label{table:disc1}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.6\columnwidth]{1-2-temp-plot}
	\includegraphics[width=.6\columnwidth]{1-2-fiss-plot}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.55\columnwidth]{1-3-vel-plot}
	\includegraphics[width=.55\columnwidth]{1-3-temp-plot}
	\includegraphics[width=.55\columnwidth]{1-3-dnp-plot}
