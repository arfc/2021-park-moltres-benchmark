...
\begin{table}[htb]
	...
	\begin{tabular}{l l c S S}
		...
		\midrule
		\multirow{4}{*}{0.1} &
		\multirow{2}{*}{$u_x$} & AA' & 0.247 & 0.253 \\
		& & BB' & 0.266 & 0.318 \\
		\cmidrule{2-5}
		& \multirow{2}{*}{$u_y$} & AA' & 0.540 & 0.598
		\\
		& & BB' & 0.468 & 0.795 \\
		\midrule
		{0.2} &
...
The discrepancy value for $T$ along centerline BB' in
Step 0.3 is marginally
...
significant spread in the $T$ distributions from all software packages near the
top boundary at $y = 2.0$ m. 
...
\begin{figure}[htb]
	...
	\caption{Step 0.3 - Temperature distribution along BB' for y = 1.9 m to
	y = 2 m.}
	\label{fig:0.3-zoom}
\end{figure}
%
...
\begin{table*}[htb]
	...
	\begin{tabular}{l l c S S}
		...
		\midrule
		\multirow{2}{*}{1.1} &
		\multirow{2}{*}{$\sum_i \lambda_i C_i$} & AA' & 0.603 & 0.346 \\
		& & BB' & 0.327 & 0.294 \\
		\midrule
		\multirow{4}{*}{1.2} &
		\multirow{2}{*}{$T$} & AA' & 0.076 & 0.095 \\
		& & BB' & 0.179 & 0.089 \\
		\cmidrule{2-5}
		& \multirow{2}{*}{\footnotesize $\Delta\left[\sum^6_g \Sigma_{f,g} \phi_g(\vec{r})
		\right]_{s_{1.2}-s_{0.2}}$} & AA' & 1.110 & 1.576 \\
		& & BB' & 1.089 & 1.133 \\
		\midrule
		\multirow{7}{*}{1.3} &
		{$u_x$} & AA' & 0.123 & 0.691 \\
		\cmidrule{2-5}
		& \multirow{2}{*}{$u_y$} & AA' & 0.237 & 0.329 \\
		& & BB' & 0.238 & 0.356 \\
		\cmidrule{2-5}
		& \multirow{2}{*}{$T$} & AA' & 0.064 & 0.057 \\
		& & BB' & 0.070 & 0.080 \\
		\cmidrule{2-5}
		& \multirow{2}{*}{$\sum_i \lambda_i C_i$} & AA' & 1.043 & 0.460 \\
		& & BB' & 0.462 & 1.194 \\
		\bottomrule
	\end{tabular}
	\label{table:disc1}
...
\begin{table}[htb]
	...
	\begin{tabular}{l l S S}
		...
		& & {Moltres} & {Benchmark} \\
		\midrule
		\multirow{2}{*}{2.1} & Gain & 0.493 & 0.587 \\
		\cmidrule{2-4}
