...
the \gls{TUD} coupled the 3D neutron diffusion software
DALTON \cite{boer_validation_2010} and the CFD software HEAT
...
\gls{CNRS} Benchmark study \cite{tiberga_results_2020}. Another multiphysics
package was developed at the Paul Scherrer Institute (PSI) coupling the
thermal-hydraulics system software \gls{TRACE} \cite{nrc_trace_2007} with the
...
interpolates the matrices during the actual transient calculations to
