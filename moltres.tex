...
Users can also opt to separate different physics through
\textit{tight coupling} in which multiphysics coupling is achieved by
fixed-point iterations.

Furthermore, applications within the
\gls{MOOSE} framework share the same programming
interface; this commonality simplifies the work required to strongly couple
...
general thermal-hydraulics modeling. Together with these modules,
