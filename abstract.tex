...
Moltres' \gls{MSR} modeling capabilities in the context of the \gls{CNRS}
benchmark, a multiphysics numerical benchmark for software dedicated to modeling
...
filled with U$^{233}$-based molten salt fuel.
The results show that Moltres is consistent with the participating
software packages published with the CNRS benchmark.
Relevant discrepancy values of measured neutronics and thermal-hydraulics
quantities from Moltres fell within similar orders of magnitude compared with
