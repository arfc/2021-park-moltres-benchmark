\begin{abstract}
Modeling strongly coupled neutronics and thermal-hydraulics in
...
numerical benchmark developed for software dedicated to modeling
...
quantities from Moltres were lower than or fell within one standard deviation of
the benchmark average. Among the participating multiphysics tools in the
benchmark, Moltres agrees closest to the in-house multiphysics tool from the
